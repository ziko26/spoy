        ...
        <div class="card"> 
            ...
            @csrf
                      ...
                      @include('admin.includes.alerts.errors')
                        <h4 class="form-section"><i class="ft-tag"></i> Create New Category</h4>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="product_name">Category Name</label>
                              <input type="text" id="product_name" value="{{ old('name') }}" class="form-control" placeholder="Name : Shirt, Choeses" name="name">
                              @error('name')
