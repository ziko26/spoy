...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/vendors/css/ui/dragula.min.css')}}">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('assets/admin/css/core/menu/menu-types/horizontal-menu.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/plugins/extensions/toastr.css')}}">
...
<script src="{{asset('assets/admin/vendors/js/extensions/dragula.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/scripts/extensions/drag-drop.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/scripts/cards/draggable.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/js/scripts/modal/components-modal.js')}}" type="text/javascript"></script>
<script src="{{asset('js/dashboard.css')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('assets/admin/vendors/js/extensions/toastr.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/admin/js/scripts/extensions/toastr.js')}}"></script>
<script>
